    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-pink-300">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-pink-100/70"
          ...
          <span className="relative">Own your dapp</span>
        </span>{' '}
        <br />
        Shape your world
      </h1>
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-pink-300 group-active:fill-current"
          >
